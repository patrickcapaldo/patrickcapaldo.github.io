...
tags:
  - tutorial
excerpt: Finding the equation of motion for a simple pendulum.
...
![](/assets/img/tutorials/simple-pendulum-derivation/pendulum_1.png)
...
![](/assets/img/tutorials/simple-pendulum-derivation/pendulum_2.png)

*Figure 3.1: Finding the temporal solution for the motion of a simple pendulum.*

![](/assets/img/tutorials/simple-pendulum-derivation/pendulum_3.png)

*Figure 3.2: Finding the temporal solution for the motion of a simple pendulum.*

![](/assets/img/tutorials/simple-pendulum-derivation/pendulum_4.png)
